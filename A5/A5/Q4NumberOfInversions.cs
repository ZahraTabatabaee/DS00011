...
namespace A5
{
    public class Q4NumberOfInversions:Processor
    {
        ...
        public (long[], long) merge((long[],long) first, (long[],long) second)
        {
        ...
        public (long[],long) mergeSort(long start, long end, long[] array)
        {
            if(start>=end)
            {
                long[] result = {array[start]}; 
                return (result,0); 
            }
